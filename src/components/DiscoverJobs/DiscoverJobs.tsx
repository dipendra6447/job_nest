...
const DiscoverJobs: React.FC = () => {
  return (
    <section className="discover-section section-padding" id="discover" aria-label="Discover jobs">
        ...
        <div className="row align-items-center g-5">
          ...
          <div className="col-lg-5">
            ...
            <h2 className="section-heading">
              Discover Thousands of <span className="gradient-text">Premium Jobs</span>
            </h2>
            <p className="section-subtext mb-4" style={{ maxWidth: '100%' }}>
              Browse jobs from top companies. Filter opportunities based on your preferences, and
              apply with a single profile. Whether you're searching for remote work, full-time roles,
              or career growth opportunities, our platform helps you connect with the right employers
              efficiently.
            </p>
            <p className="section-subtext mb-4" style={{ maxWidth: '100%' }}>
              Browse jobs from top companies. Filter opportunities based on your preferences, and
            ...
            <div className="d-flex flex-wrap gap-3 mt-2">
              <a href="#" className="btn-primary-custom" id="discover-browse-btn">
          ...
          <div className="col-lg-7">
            <div className="discover-mosaic" aria-label="Recruitment imagery">
              ...
              <div className="mosaic-stat-box" aria-label="Recruitment statistics">
                <p className="msb-number">720+</p>
                <p className="msb-label">Recruitment done</p>
                <div className="msb-avatars" aria-label="Recruited professionals">
                  <span className="msb-avatar" aria-hidden="true">👩‍💼</span>
                  <span className="msb-avatar" aria-hidden="true">👨‍💻</span>
                  <span className="msb-avatar" aria-hidden="true">👩‍🔬</span>
                  <span className="msb-avatar" aria-hidden="true">👨‍🎨</span>
                  <span className="msb-avatar msb-avatar--more" aria-label="and more">+</span>
                </div>
              </div>
