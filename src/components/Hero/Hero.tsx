...
const popularSearches = ['Web Developer', 'Marketing Agency', 'Graphics', 'Saloon', 'UI/UX Designer'];
              ...
              <form onSubmit={handleSearch} role="search" aria-label="Job search form">
                <div className="hero-search-fields">
                  ...
                  <div className="hero-search-field">
                    <label className="hero-search-label" htmlFor="hero-keyword">What?</label>
                    <input
                      id="hero-keyword"
                      type="text"
                    ...
                    />
                    <i className="bi bi-chevron-down hero-field-arrow" aria-hidden="true" />
                  </div>
                  ...
                  {/* Where? */}
                  <div className="hero-search-field">
                    <label className="hero-search-label" htmlFor="hero-location">What?</label>
                    <input
                      id="hero-location"
                      type="text"
                      className="hero-search-input"
                  ...
                  {/* Category */}
                  <div className="hero-search-field">
                    <label className="hero-search-label" htmlFor="hero-category">What?</label>
                    <input
                      id="hero-category"
                      type="text"
                      className="hero-search-input"
              ...
              <div className="hero-popular-row">
                ...
                {popularSearches.map(term => (
                  <button
                    ...
                    id={`popular-hero-${term.toLowerCase().replace(/\s+/g, '-')}`}
                    type="button"
                  >
                    {term}
                  </button>
